...
client.on("ready", (async () => {
	...
	const e = await RichPresence.getExternal(client, "857843402807967776", "https://media.discordapp.net/attachments/1033549666769449002/1107009612210765955/matches.png"),
		t = (new RichPresence).setType(1).setURL("https://www.youtube.com/watch?v=9SH_iSb3-HU").setName("Korepi").setStartTimestamp(Date.now()).setAssetsSmallText("What.").setAssetsSmallImage(e[0].external_asset_path);
